...
$body = '{"model": "grok-2-vision-1212", "prompt": "a cute cat sticker", "n": 1, "size": "1024x1024", "response_format": "b64_json"}'
try {
    Write-Host "Sending request to xAI Grok API (grok-2-vision-1212)..."
