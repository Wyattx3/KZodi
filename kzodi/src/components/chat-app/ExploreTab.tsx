...
export default function ExploreTab({ onSelectCharacter }: ExploreTabProps) {
    ...
    // Featured character (first trending one)
    const featured = characters.length > 0 ? characters[0] : null;

    // For You picks (trending items 2, 3, 4)
    const forYou = useMemo(() => {
        return characters.slice(1, 4);
    }, [characters]);
            ...
            >
                <div className="explore-search-glass">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Search trending characters..."
                        value={search}
                            ...
                            <div className="explore-featured-card" onClick={() => onSelectCharacter(featured)}>
                                <div className="explore-featured-img-wrap">
                                    ...
                                    <div className="explore-featured-content">
                                        <span className="explore-featured-label">#1 Trending</span>
